...
contract GlobalAccessControl is Initializable, AccessControlUpgradeable, PausableUpgradeable {
    ...
    function initialize(address _initialContractGovernance) external initializer {
    ...
    function getRoleMembersByString(string memory roleString) public view returns (address[] memory) {
    ...
    function initializeNewRole(bytes32 role, string memory roleString, bytes32 adminRole) external {
